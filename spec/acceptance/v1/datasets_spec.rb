  ...
  describe 'Datasets', type: :request do
    context 'For specific dataset' do
      ...
      context 'With params' do
        ...
        # Disabled tests for non supporting methods on convert service
        ...
        #   post "/query/#{dataset_id}?sql=select cartodb_id,pcpuid from public.carts_test_endoint where cartodb_id != 4 and pcpuid not between '500001' and '9506590' order by pcpuid DESC", params: params
