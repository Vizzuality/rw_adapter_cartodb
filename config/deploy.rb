...
set :deploy_to, '/home/ubuntu/rw_adapter_cartodb'
...
task :environment do
  ...
  invoke :'rvm:use[ruby-2.3.0@rw_adapter_cartodb]'
end
...
task :deploy => :environment do
  ...
  deploy do
    ...
    to :launch do
      queue 'fuser -n tcp -k 3005'
      queue 'bundle exec puma -d -t 5:5 -p 3005 -e production -S ~/puma -C config/puma.rb'
    end
  end
end
